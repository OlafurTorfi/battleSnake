...
function findMove(body, levelsToEvaluate, hasRandom) {
    if (levelsToEvaluate === void 0) { levelsToEvaluate = 9; }
    ...
    console.log('Debug moveForward: ', JSON.stringify(moveForward), ', moveLeft:', JSON.stringify(moveLeft), ', moveRight: ', JSON.stringify(moveRight));
    ...
    if (nextMove === 'CannotFindApple') {
        ...
        return decideWhichMove_1.decideWhichMove(stateForward, stateLeft, stateRight);
    }
    return nextMove;
}
